...
<html lang="en">
  ...
  <body style="background-color: #d2d2ce">
    <nav class="navbar navbar-expand-lg bg-dark">
    <div class="container">
        <a class="navbar-brand text-warning" href="#">Buku</a>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
            <a class="nav-link active text-warning" aria-current="page" href="tambah.php">Tambah Buku</a>
            </li>
        </ul>
        </div>
    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="card mb-3">
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                            <div class="card-body">
                                <span class="position-absolute top-0 end-0 bg-secondary text-white px-1 py-1 opacity-50"><small><?= $b['kategori'] ?></small></span>
